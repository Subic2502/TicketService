...
public class EventData implements Serializable {
	...
	public String toString() {
		return "EventData [eventId=" + eventId + ", attendance=" + attendance + ", createdAt=" + createdAt
				+ ", eventDate=" + eventDate + ", eventDescription=" + eventDescription + ", eventLocation="
				+ eventLocation + ", eventName=" + eventName + ", tickets=" + tickets + "]";
	}
